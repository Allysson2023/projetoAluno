...
class App:
    def __init__(self):
        ...
        self.label_matricula = Label(self.janela, text="Matricula", font="Tahoma 14 bold", fg="blue")
        ...
        self.curso = ["Python", "Javascript", "HTML&CSS", "React"]
        self.combo_curso = ttk.Combobox(self.janela, values=self.curso, width=25, font="Tahoma 14")
        ...
        self.button_adcionar = Button(self.janela, text="Adcionar", font="Tahoma 12 bold", width=7, fg="blue", command=self.cadastraAluno)
        self.button_adcionar.grid(row=5, column=0)
        ...
        self.coluna = ["Matricula", "Nome", "Idade", "Curso", "Nota"]
        self.tabela = ttk.Treeview(self.frame, columns=self.coluna, show="headings")
